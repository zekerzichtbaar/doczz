...
const config = {
  title: 'DocZZ',
  tagline: 'Zekerzichtbaar Documentation & Snippets',
  ...
  organizationName: 'zekerzichtbaar', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: 'dark',
        copyright: `Copyright © ${new Date().getFullYear()} Zeker Zichtbaar. Built with Docusaurus.`,
      },
      prism: {
